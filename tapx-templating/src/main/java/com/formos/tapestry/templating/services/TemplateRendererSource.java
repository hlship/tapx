...
package com.formos.tapestry.templating.services;

import com.formos.tapestry.templating.TemplateRenderer;

/**
 * A source for {@link com.formos.tapestry.templating.TemplateRenderer}s, which are used to transform a Tapestry page
 * (the template) and a set of data into {@link com.formos.tapestry.templating.RenderedStream}.
 */
