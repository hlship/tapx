 ...
 * advice for the {@link com.formos.tapestry.templating.services.TemplateRendererSource} service. This filter doesn't
 ...
 * the alternative is more awkard (making {@link com.formos.tapestry.templating.TemplateAPI#performTemplateRendererOperation(String,
 * String, String, com.formos.tapestry.templating.TemplateRendererCallback)} the <em>only</em> way to render a
 * template).
 */
