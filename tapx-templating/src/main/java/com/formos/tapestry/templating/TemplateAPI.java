...
import com.formos.tapestry.templating.internal.TemplateContext;
import com.formos.tapestry.templating.services.TemplateModule;
...
public class TemplateAPI implements TemplateRendererSource
{
    ...
    /**
     * A convienience for performing an operation with a {@link com.formos.tapestry.templating.TemplateRenderer}, then
